  ...
  def reasons do
    [
      ...
      {"Certain Type/Location Only",
       "I only want to allow art of a certain type or from a certain location to be uploaded to Cutepa.ws"},
      {"With Permission Only",
       "I only want people with my permission to be allowed to upload my art to Cutepa.ws"},
      {"Artist Upload Only",
       "I want to be the only person allowed to upload my art to Cutepa.ws"},
